const FILES={spin:'slotPull.mp3',stop:'reelStop.mp3',small:'winSmall.wav',medium:'slotWin.mp3',large:'slotWin.mp3',feature:'slotFeature.mp3',free:'scatterHit.mp3',complete:'slotFeature.mp3',coin:'coinHandling.wav'};
...
export class GameAudio{
  ...
  completion(){this.play(FILES.small);}
}
